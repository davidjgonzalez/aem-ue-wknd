...
## Environments
- Preview: https://main--aem-ue-wknd--davidjgonzalez.aem.page/
- Live: https://main--aem-ue-wknd--davidjgonzalez.aem.live/
...
1. Open the `aem-ue-wknd` directory in your favorite IDE and start coding :)
